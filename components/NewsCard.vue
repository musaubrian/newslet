<template>
    ...
    <div class="px-5 my-3">
        ...
        <div class="text-justify px-1 flex flex-col justify-center items-center my-2 ">
            <p class="text-lg text-gray-700">{{ article.description }}</p>
            <a :href=article.url target="_blank"
                class="bg-sky-500 rounded-md font-semibold text-lg p-3 my-2  text-gray-100 cursor-pointer">
                Keep reading
            </a>
